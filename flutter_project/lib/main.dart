...
class _ProductListPageState extends State<ProductListPage> {
  List<Product> productList = [
    Product("Product Eyeshadow", 139000),
    Product("Product Lip Ice", 25500),
    Product("Product Hair Repair Mask", 15755),
    Product("Product Cushion", 109000),
    Product("Product Face Wash", 39000),
    Product("Product Parfume", 98000),
    Product("Product Liptint", 63000),
    Product("Product Eyeliner", 55000),
    Product("Product Maskara", 110000),
    Product("Product Face Mask", 30000),
  ];
